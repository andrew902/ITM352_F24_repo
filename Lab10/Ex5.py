import pandas as pd
# Read in a CSV file containing real estate data in NYC, and urn it into a DataFrame

df_homes = pd.read_csv("../homes_data.csv")

# Print the dimmensions of the data and the first 10 rows
shape = df_homes.shape
print(f"The homes data has {shape[0]} rows and {shape[1]} columns")

# Select properties with 500 or more units and drop unecessary columns
...
print("The average sales price of big apartments is: $", round(df_big_apartments['sale_price'].mean()))